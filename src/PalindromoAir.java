public class PalindromoAir {
    ...
    public PalindromoAir(Ticket[] asientos){
    ...
    public void sellTicket(String name){
        ...
        if(disponibilidad!=-1){
            ...
            System.out.println("Monto a pagar: $."+precioTicket);
        } else {
    ...
    public void dispatch(){
        double ingresoTotal=income();
        System.out.println("Ingresos totales generados: $."+ingresoTotal);
        reset();
    }
}
